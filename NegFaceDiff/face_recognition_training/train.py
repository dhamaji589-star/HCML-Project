...
def main(args):
    ...
    if args.augment != "None":
        output_dir = os.path.join(root_folder, "FR", cfg.architecture + "_data_aug", f"_w{cfg.width}_d{cfg.depth}")
    else:
        output_dir = os.path.join(root_folder, "FR", cfg.architecture, f"_w{cfg.width}_d{cfg.depth}")
